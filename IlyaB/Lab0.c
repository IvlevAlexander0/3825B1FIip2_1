...
int main() {
    ...
    if (distance == 0.0f) {
        ...
        else if (distance + min(r1, r2) == max(r1, r2)) printf("The circles contact each other\nOne circle is within the other one");
        else if (distance + min(r1, r2) < max(r1, r2)) printf("One circle is within the other one");
